...
arnona = {
    'משרד, שירותים ומסחר': geojson.load(open('./arnona/arnona_zone_mishar.geojson')),
    'תעשיה': geojson.load(open('./arnona/arnona_zone_taasia.geojson')),
    'מבני מגורים': geojson.load(open('./arnona/arnona_zone_megurim.geojson')),
}
